export class CollisionBox {
    ...
    vx = 0;
    vy = 0;
    constructor(x, y, width, height, hp = 20 + Math.round(Math.random() * 190)) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    render(ctx) {
        ...
        this.x += this.vx;
        this.y += this.vy;
        const collisions = Object.keys(this.collided).filter((i) => this.collided[i]).length;
