...
class Config {
  ...
  public ORCHESTRATOR_EXPERTS_PER_LAYER = 1;
  /** single hidden layer, it only has to route the inputs to the right brain */
  public ORCHESTRATOR_HIDDEN_NODES = 12;
  /** mutations are boosted, every expert is good at something worth trying */
  public ORCHESTRATOR_MUTATION_BOOST = 3;
  /** odds of rerolling every weight leading to one expert, scaled by the factor */
  public ORCHESTRATOR_RESET_CHANCE = 0.15;
  public ORCHESTRATOR_MAX_MUTATION_LVL = 0.3;
  public ORCHESTRATOR_COLOR = 'hsl(180, 100%, 65%)';
