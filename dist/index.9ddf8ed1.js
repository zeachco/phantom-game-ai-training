...
})({"hm9EO":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "73c8455a9ddf8ed1";
...
},{}],"2AMfI":[function(require,module,exports) {
var _ball = require("./Ball");
var _collisionBox = require("./CollisionBox");
var canvas = document.createElement("canvas");
document.body.appendChild(canvas);
var ctx = canvas.getContext("2d");
var GW = canvas.width = 800;
var GH = canvas.height = 600;
const leftPlayer = new _collisionBox.CollisionBox(50, 150, 20, 140);
const rightPlayer = new _collisionBox.CollisionBox(GW - 50, 150, 20, 140);
const allBoxes = [
    leftPlayer,
    rightPlayer
];
...
for(var i = 0; i < 5; i++){
    ...
    allBoxes.push(new _collisionBox.CollisionBox(x, y, 5 + area, 5 + (150 - area)));
    allBalls.push(new _ball.Ball(GW / 2, GH / 2, 25));
}
renderGame();
function renderGame() {
...
},{"./Ball":"lHT7Z","./CollisionBox":"5Jrq1"}],"lHT7Z":[function(require,module,exports) {
...
},{}],"5Jrq1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CollisionBox", ()=>CollisionBox
);
class CollisionBox {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hm9EO","2AMfI"], "2AMfI", "parcelRequire4d03")

//# sourceMappingURL=index.9ddf8ed1.js.map
